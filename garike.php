...
<div class="content">
    ...
    <div class="heading" >Garike(Dhruva):</div>

    <?php
        // PHP logic to set the image source and paragraph text
        $imageSrc = 'garike.jpg'; // Replace with the actual path to your image
        $paragraphText = 'Durva grass is considered a sacred plant in India. It is religious for Hindus as they worship Lord Ganesha with durva grass. While this plant known as cynodon dactylon. Its blades are a grey-green colour and are short, usually 2–15 cm long with rough edges. The erect stems can grow 1–30 cm tall. The stems are slightly flattened, often tinged purple in colour. Doob grass is used to enhance immunity of the body. Cynodon dactylon contains a bio-chemical compound called cynodon dactylon protein fractions (cdpf), which helps to enhance immunity of the body. It is easily available and affordable immune booster and energizer.
